...
from attention_bw.visualize import load_results, visualize
...
def build_parser() -> argparse.ArgumentParser:
    ...
    viz_parser.add_argument("input", type=Path, help="Path to NCU results CSV file")
...
def run_benchmarks(args: argparse.Namespace) -> int:
    ...
    for case in cases:
        for kernel in args.kernels:
            try:
                print(f"Running {kernel} with shape ({case.batch}, {case.heads}, {case.seq}, {case.dim})")
